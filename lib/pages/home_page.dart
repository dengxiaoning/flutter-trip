...
import 'package:flutter_trip_app/widget/grid_nav.dart';
import 'package:flutter_trip_app/widget/local_nav.dart';
import 'package:flutter_trip_app/widget/sales_box.dart';
import 'package:flutter_trip_app/widget/search_bar.dart';
import 'package:flutter_trip_app/widget/sub_nav.dart';
...
//    });
    try {
      ...
      setState(() {
        ...
        salesBoxModel = model.saleBoxModel;
...
//        Container(  /// 设置空白内容高度撑开页面,使用ListTile 返回一个scrolling list  测试list view
//            height: 800,
//            child: ListTile(
